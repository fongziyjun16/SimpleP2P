    ...
    private void buildConnection(Socket connection, boolean isPositive) throws Exception {
        ...
        synchronized (connectedNeighbors) {
            if (!connectedNeighbors.containsKey(neighborID)) {
                try {
                    PeerConnection peerConnection = new PeerConnection(peerHandler, this, neighborID, ois, oos);
                    ...
                    logger.log(Level.INFO, "Make " + (isPositive ? "Positive" : "Negative") + " Connection with " + neighborID);
